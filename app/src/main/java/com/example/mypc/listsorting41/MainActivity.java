package com.example.mypc.listsorting41;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stringList.add("Computers");
        stringList.add("Punjabi");
        stringList.add("Sanskrit");
        stringList.add("Biology");
        stringList.add("Music");

        stringAdapter = new StringAdapter(MainActivity.this, android.R.layout.simple_list_item_activated_1, stringList);
